...
//deviceInfo struct represents an abstract ONVIF MyDevice.
//It contains methods, which helps to communicate with ONVIF MyDevice
...
func (dev *MyDevice) GetServices() map[string]string {
...
func GetAvailableDevicesAtSpecificEthernetInterface(interfaceName string) []MyDevice {
	/*
...
func (dev *MyDevice) getSupportedServices(resp *http.Response) {
...
func NewDevice(xaddr string) (*MyDevice, error) {
	dev := new(MyDevice)
	dev.xaddr = xaddr
...
func (dev *MyDevice) addEndpoint(Key, Value string) {
...
func (dev *MyDevice) Authenticate(username, password string) {
	dev.login = username
	dev.password = password
}

//GetEndpoint returns specific ONVIF service endpoint address
func (dev *MyDevice) GetEndpoint(name string) string {
...
func (dev MyDevice) CallMethod(method interface{}) (*http.Response, error) {
...
func (dev MyDevice) callNonAuthorizedMethod(endpoint string, method interface{}) (*http.Response, error) {
	//TODO: Get endpoint automatically
	/*
...
func (dev MyDevice) callAuthorizedMethod(endpoint string, method interface{}) (*http.Response, error) {
	/*
		Converting <method> struct to xml string representation
	*/
	output, err := xml.MarshalIndent(method, "  ", "    ")
